...
/// [StoreChangeHandler] handles a change the store after an action of
/// type Action<T>.
...
/// perform handlers for a given set of actions with many different payload
/// types, while maintaining type safety. Each [StoreChangeHandler] added
/// with add<T> must take a [StoreChange] with prev and next of type
/// <State, StateBuilder> an Action of type Action<T>,
